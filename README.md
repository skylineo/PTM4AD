...
| GeoMAE: Masked geometric target prediction for self-supervised point cloud pre-training | [link](https://openaccess.thecvf.com/content/CVPR2023/papers/Tian_GeoMAE_Masked_Geometric_Target_Prediction_for_Self-Supervised_Point_Cloud_Pre-Training_CVPR_2023_paper.pdf) | [code](https://github.com/Tsinghua-MARS-Lab/GeoMAE) |
| GeoMIM: Towards better 3d knowledge transfer via masked image modeling for multi-view 3d understanding | [link](https://openaccess.thecvf.com/content/ICCV2023/papers/Liu_GeoMIM_Towards_Better_3D_Knowledge_Transfer_via_Masked_Image_Modeling_ICCV_2023_paper.pdf) | none |
...
| LiDAR-guided geometric pretraining for vision-centric 3d object detection | [link](https://link.springer.com/article/10.1007/s11263-025-02351-4) | [code](https://github.com/OpenDriveLab/Birds-eye-view-Perception?tab=readme-ov-file) |
| CooPre: Cooperative pretraining for v2x cooperative perception | [link](https://arxiv.org/pdf/2408.11241) | [code](https://github.com/ucla-mobility/CooPre) |
...
| PreTraM: Self-Supervised Pre-training via Connecting Trajectory and Map | [link](https://arxiv.org/pdf/2204.10435) | none |
...
| Large language models powered context-aware motion prediction in autonomous driving | [link](https://arxiv.org/pdf/2403.11057?) | [code](https://github.com/AIR-DISCOVER/LLM-Augmented-MTR) |
...
| AutoReward: Closed-loop reward design with large language models for autonomous driving | [link](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10735123) | [code](https://github.com/DLR-RM/stable-baselines3) |
...
| FASIONAD: FAst and Slow FusION Thinking Systems for Human-Like Autonomous Driving with Adaptive Feedback | [link](https://arxiv.org/pdf/2411.18013) | none |
| AutoDrive-R²: Incentivizing Reasoning and Self-Reflection Capacity for VLA Model in Autonomous Driving | [link](https://arxiv.org/pdf/2509.01944) | none |
